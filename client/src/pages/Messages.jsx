...
function Messages() {
  ...
  // Load users connected through accepted/completed bookings
  useEffect(() => {
      ...
      try {
        ...
        res.data
          ...
          .forEach((booking) => {
            ...
            const isRequester =
              booking.requester?._id === currentUser?._id;
        ...
        if (!cancelled) {
          ...
          setMessage(
            ...
            'Could not load your booking connections.'
          );
  ...
  // Open conversation automatically from Bookings Message button
  useEffect(() => {
  ...
  return (
    ...
    <AppShell
      ...
      title="Keep the exchange human."
      description="Message people you are connected with through an accepted booking."
    >
          ...
          {!loadingConnections &&
            connections.length === 0 && (
              ...
              <div className="empty-state">
                ...
                You can message members after a booking is accepted.
          ...
          {!loadingMessages &&
            !userId && (
              ...
              <div className="empty-state">
                ...
                <strong>
                  Select a connected member
                </strong>


                Pick someone from your accepted bookings to start messaging.
