...
function Browse() {
  ...
  return (
    <AppShell
      eyebrow="The skill directory"
      title="Find your next teacher."
      description="Browse real people, practical skills, and exchanges that fit into your life."
      action={
    ...
    >
      ...
      {loading && (
        <div className="empty-state">
          ...
          Loading the latest skill profiles...
        </div>
      )}
      ...
      {!loading && visibleUsers.length === 0 && (
        <div className="empty-state">
          ...
          Try a broader skill or check back soon.
        </div>
      )}
          ...
          >
            ...
            {user.skillsOffered?.map((skill) => (
              ...
              <button
                ...
                key={skill}
                onClick={() =>
                  openBookingForm(user._id, skill)
                }
              >
      ...
      {bookingForm && (
        ...
        <div className="modal-backdrop">
          ...
          <section className="booking-modal surface">
            ...
            <h2>
              Request {bookingForm.skill}
            </h2>



            <p className="page-description">
              Choose a time that works for you. The other person can accept or suggest another moment.
            </p>
