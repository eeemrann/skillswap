...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setError(clerkError?.longMessage || clerkError?.message || 'Google sign-in could not be started.');
      setSubmitting(false);
    }
  };
    ...
    <AuthLayout mode="login">
      <form className="custom-clerk-form" onSubmit={handleSubmit}>
        ...
        <div className="auth-field">
          ...
          <input id="login-email" type="email" autoComplete="email" value={emailAddress} onChange={(event) => setEmailAddress(event.target.value)} placeholder="Enter your email address" required />
        </div>
        <div className="auth-field">
