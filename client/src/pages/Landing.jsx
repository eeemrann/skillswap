  ...
  return (
    <main className="landing-page">
      ...
      <section className="landing-hero">
        ...
        <div className="hero-visual" aria-label="Example skill exchange"><div className="visual-glow"/><div className="floating-chip chip-one">Photography <span>+1 hr</span></div><div className="floating-chip chip-two">Spanish <span>Booked</span></div><div className="exchange-scene"><div className="scene-head"><span>Upcoming exchange</span><span className="live-dot">Confirmed</span></div><div className="scene-person"><span className="scene-avatar">AM</span><div><strong>Spanish with Amara</strong><small>Today, 6:30 PM &middot; 60 minutes</small></div></div><div className="scene-divider"/><div className="scene-meta"><div><small>Your balance</small><strong>8.5 credits</strong></div><div className="scene-people"><span>JL</span><span>MR</span><span>+4</span></div></div><button type="button">View session <Icon name="arrow" size={15}/></button></div></div>
      </section>
